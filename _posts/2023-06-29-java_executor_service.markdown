---
layout: post
title:  關於Java ExecutorService - 上篇
date:   2023-06-29
author: 聶羽鵬
categories: Java
...
今天跟大家介紹`java.util.concurrent.ExecutorService`,  這個主題將分上下兩部分做介紹. 本文章是上半部分, 下半部分請見[連結]({{ site.baseurl }}{% post_url 2023-06-30-java_executor_service_2 %}).
...
![JVM無法即刻中止]({{ site.baseurl }}/assets/images/post220629/post220629_1.PNG)

我們可以看一下JVM的threads實際的執行歷程狀況(利用`NetBeans`的`Profile工具`), 如下圖:

![Profile_threads_1]({{ site.baseurl }}/assets/images/post220629/post220629_2.PNG)
[點此開啓新視窗檢視]({{ site.baseurl }}/assets/images/post220629/post220629_2.PNG){:target="_blank"}
...
![Profile_threads_1]({{ site.baseurl }}/assets/images/post220629/post220629_3.PNG)
[點此開啓新視窗檢視]({{ site.baseurl }}/assets/images/post220629/post220629_3.PNG){:target="_blank"}
...
![Profile_threads_1]({{ site.baseurl }}/assets/images/post220629/post220629_4.PNG)
[點此開啓新視窗檢視]({{ site.baseurl }}/assets/images/post220629/post220629_4.PNG){:target="_blank"}
